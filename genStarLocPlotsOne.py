...
for locF,massF,ZF,ppfF,pzfF in zip(locFiles,massFiles,ZFiles,ppfFiles,ppzFiles):
    ...
    for indx, poi in enumerate(poisFiles):
        ...
        ax1.scatter(xcoord[rng4], ycoord[rng4], s=massFilt[rng4]/dotNorm, c=z4, cmap=cmap,vmin=-7.5, vmax=0)
        ax1.scatter(xcoord[rng3], ycoord[rng3], s=massFilt[rng3]/dotNorm, c=z3, cmap=cmap,vmin=-7.5, vmax=0)
        ax1.scatter(xcoord[rng2], ycoord[rng2], s=massFilt[rng2]/dotNorm, c=z2, cmap=cmap,vmin=-7.5, vmax=0)
